...
class signing_scriptworker::settings {
    ...
    $env_config = {
        ...
        'appsv-dep' => {
            ...
            scope_prefixes           => ['project:mobile:focus:releng:signing:', 'project:mobile:android-components:releng:signing:', 'project:mobile:fenix:releng:signing:', 'project:mobile:reference-browser:releng:signing:', 'project:mozilla:application-services:releng:signing'],
            sign_chain_of_trust      => false,
            verify_chain_of_trust    => true,
            verify_cot_signature     => false,
