...
#OS X batch#8 10 machines(adding yosemite-r7-(0100-0109)) migrate in taskcluster- Bug 1364924
node /t-yosemite-r7-0(0[^0-2]\d|1[0]\d)\.test\.releng\.scl3\.mozilla\.com/ {
