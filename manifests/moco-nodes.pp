...
#OS X batch#21 30 machines(adding yosemite-r7-(0310-0339)) migrate in taskcluster- Bug 1364924
node /t-yosemite-r7-0(0[^0-2]\d|[1-2]\d+|3[0-3]\d)\.test\.releng\.scl3\.mozilla\.com/ {
