...
#OS X batch#11 10 machines(adding yosemite-r7-(0130-0139)) migrate in taskcluster- Bug 1364924
node /t-yosemite-r7-0(0[^0-2]\d|1[0-3]\d)\.test\.releng\.scl3\.mozilla\.com/ {
