...
#OS X batch#12 10 machines(adding yosemite-r7-(0140-0149)) migrate in taskcluster- Bug 1364924
node /t-yosemite-r7-0(0[^0-2]\d|1[0-7]\d)\.test\.releng\.scl3\.mozilla\.com/ {
