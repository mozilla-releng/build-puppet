...
#OS X batch#10 10 machines(adding yosemite-r7-(0120-0129)) migrate in taskcluster- Bug 1364924
node /t-yosemite-r7-0(0[^0-2]\d|1[0-2]\d)\.test\.releng\.scl3\.mozilla\.com/ {
