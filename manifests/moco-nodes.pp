...
#OS X batch#19 30 machines(adding yosemite-r7-(0250-0279)) migrate in taskcluster- Bug 1364924
node /t-yosemite-r7-0(0[^0-2]\d|1\d+|2[0-7]\d)\.test\.releng\.scl3\.mozilla\.com/ {
