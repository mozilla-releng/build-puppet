...
#OS X batch#18 30 machines(adding yosemite-r7-(0220-0249)) migrate in taskcluster- Bug 1364924
node /t-yosemite-r7-0(0[^0-2]\d|1\d+|2[0-4]\d)\.test\.releng\.scl3\.mozilla\.com/ {
